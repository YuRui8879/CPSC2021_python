...
def viz_gen(x, cmap='bwr', norm_rel=1, norm_abs=None):
    ...
    _make_plots(np.abs(x), np.imag(x), cmap=cmap,
...
def viz_gen2(x1, x2, cmap='bwr', norm_rel=1, norm_abs=None):
    ...
    _make_plots(np.abs(x1), np.real(x2), cmap=cmap,
...
# %%
viz_gen(Tx_yc, cmap='bwr')
viz_gen(Tx_ys, cmap='bwr')
# %%
"""Paper [1], pg. 1086"""
...
# %%
viz_gen2(Tx_sc, Tx_sNc, cmap='bwr')
viz_gen2(Tx_ss, Tx_sNs, cmap='bwr')
# %%
...
# %%
viz_gen2(Wx_s, Wx_sN, cmap='bwr')
viz_gen2(Sx_s, Sx_sN, cmap='bwr')
