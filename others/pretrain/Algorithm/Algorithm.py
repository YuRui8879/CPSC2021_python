...
class Algorithm():
    ...
    def __init__(self,parallel = True):
        ...
        self.save_path = r'..\..\..\model\pretrain'
        data_path = r'..\..\..\data\physionet'
        ...
        test_adapter = DataAdapter(data_path,mode = 1)
    ...
    def test(self):
        ...
        model.load_state_dict(torch.load(os.path.join(self.save_path,'pretrain_model.pt')))
        model.cuda()
        start_time = time.time()
...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model):
        ...
        torch.save(model.state_dict(), os.path.join(self.save_path,'pretrain_model.pt'))
